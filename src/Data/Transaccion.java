...
public class Transaccion implements Serializable {
	...
	public boolean procesoTransaccion() {
		...
		for(TransaccionEntrada i : entradas) { //recopilar entrada transaccinoes
			i.UTXO = EduPay.UTXOs.get(i.idTransaccionSalida);
		}
		if(obtenerValorEntrada() < EduPay.transaccionMinima) { //Verificar si la transaccion es valida 
			JOptionPane.showMessageDialog(null, "Valor de transaccion es muy pequeño: " + obtenerValorEntrada(), " " ,JOptionPane.ERROR_MESSAGE);
			JOptionPane.showMessageDialog(null, "Ingrese un monto mas grande que: " + EduPay.transaccionMinima, " " ,JOptionPane.INFORMATION_MESSAGE);
			System.out.println();
			return false;
		}
